...
KERNEL ?= 4.19.134
KERNEL_ARCH ?= x86_64
KERNEL_SOURCE ?= https://cdn.kernel.org/pub/linux/kernel/v4.x/linux-4.19.134.tar.xz
KERNEL_SHA256 ?= 7d7da84f65d31546911283c36478b548bc78c4139061a7a0241feca8318e3a6f
